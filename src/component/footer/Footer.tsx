  ...
  return (
    <>
      ...
      <Grid container spacing={2.5} className="footer_content_container">
        ...
        <Grid item xs={1.8} className="footer_column_container">
        ...
        <Grid item xs={2.5} className="footer_column_container">
          ...
          <div style={{ display: "flex" }}>
            <TextField placeholder="Your Email" style={{ marginRight: "3%" }} />
            <Button
              variant="contained"
              color="primary"
      ...
      <Grid
        container
        spacing={9}
        className="footer_waterMark_container"
        sx={{
          display: "flex",
      ...
      >
        ...
        >
          <Typography
            className="footer-bottom-one-text"
            fontSize={35}
        ...
        <Grid
          item
          xs={5}
          className="footer_dropdown_div"
          sx={{ display: "flex", paddingTop: "1% !important" }}
        >
          <Select value={10} sx={{ m: 1, minWidth: 250, color: "black" }}>
            <MenuItem value="">
          ...
          <Select value={10} sx={{ m: 1, minWidth: 120, color: "black" }}>
            <MenuItem value="">
              <em>$USD</em>
            </MenuItem>
